...
#define TARGET_DEVICE_NAME "ESPPP"  // Cambiar según el nombre del emisor configurado
...
const float TEMP_THRESHOLD = 25;  // Cambiar según el umbral deseado
// ===============================================
