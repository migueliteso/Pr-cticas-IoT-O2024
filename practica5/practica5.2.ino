...
#include <WiFi.h>
// secrets.h
#define SECRET_SSID "IoT" // SSID
#define SECRET_PASS "1t3s0IoT23" // contraseña de WiFi
#define SECRET_CH_ID 2720904 // ID de canal de ThingSpeak
#define SECRET_WRITE_APIKEY "0UM7MQ9X6DGB96BY" // API Key de ThingSpeak

#define OPENWEATHER_REQUEST_PATH "https://api.openweathermap.org/data/2.5/weather?lat=20.606900&lon=-103.415629&appid=931046b5a2ba222d7c9d44f028f3a453&units=metric"
