// Práctica hecha por Miguel Helu - clase IoT
...
byte Usuario1[4] = {0x21, 0x12, 0x2F, 0x23}; // UID tarjeta CON acceso (reemplaza por tu UID)
byte Usuario2[4] = {0x66, 0xAA, 0x61, 0x33}; // UID de otra tarjeta que quieras que tenga acceso
