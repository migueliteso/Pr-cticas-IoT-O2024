...
Serial.println("");
Serial.println("IoT"); 
Serial.print("La dirección IP es:148.201.216.214/"); 
Serial.println(WiFi.localIP()); //MuestraIP // Inicio del Servidor web.
server.begin();
...
client.println("<body><center><fontface='Arial'>"); 
client.println("<h1>Servidor web con ESP32.</h1>"); 
client.println("<h1>Miguel Helu</h1>");
